...
if [ -f $QRV_PROFILE_DIR/${QRV_PROFILE}/$MODULE/WSJT-X_${QRV_PROFILE}.ini ]; then
	mv $QRV_PROFILE_DIR/${QRV_PROFILE}/$MODULE/WSJT-X_${QRV_PROFILE}.ini $QRV_PROFILE_DIR/${QRV_PROFILE}/$MODULE/WSJT-X_${QRV_PROFILE}_$(date +"%F_%H%M").ini
	cp $HOME/.config/WSJT-X.ini $QRV_PROFILE_DIR/${QRV_PROFILE}/$MODULE/WSJT-X_${QRV_PROFILE}.ini
else
